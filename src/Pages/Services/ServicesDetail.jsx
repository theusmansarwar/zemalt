...
import { TbDeviceAnalytics, TbMapPinSearch, TbMessages, TbPencilSearch, TbSeo } from "react-icons/tb";
...
import { MdManageSearch, MdOutlineArticle, MdOutlineCardTravel, MdOutlineDesignServices, MdOutlineShoppingBag, MdOutlineSupportAgent, MdOutlineTouchApp } from "react-icons/md";
      ...
      case "UI Designing":
        setServicesData({
          introduction:
            ...
            {  icon: <DiResponsive  />,name: "Responsive Design", description: "Ensure optimal viewing experiences across all devices and screen sizes." },
          ],
          benefits: [
          ...
          case "Social Media Ads":
            setServicesData({
              introduction:
                ...
                services: [
                { icon: <FaBullhorn />, name: "Social Media Strategy Development", description: "Design comprehensive strategies tailored to meet brand goals and engage target audiences." },
                { icon: <FaBullhorn />, name: "Content Creation and Scheduling", description: "Develop engaging content and schedule posts to maintain a consistent online presence." },
                { icon: <FaBullhorn />, name: "Community Management", description: "Foster relationships with followers by responding to comments and messages, building a loyal community." },
                ...
                { icon: <FaBullhorn />, name: "Influencer Partnerships", description: "Collaborate with influencers to extend reach and enhance brand credibility through authentic endorsements." },
                { icon: <FaBullhorn />, name: "Performance Analytics and Reporting", description: "Analyze social media metrics to assess campaign effectiveness and inform future strategies." },
                { icon: <FaBullhorn />, name: "Platform-Specific Optimization", description: "Tailor content and strategies to maximize performance on each social media platform." }
              ],
              benefits: [
                { name: "Stronger Presence & Deeper Connections", description: "Boost brand visibility across multiple platforms to enhance recognition. Foster meaningful customer interactions that drive engagement and loyalty. Gain valuable insights into customer preferences to refine future marketing strategies." },
                { name: "Boosted Traffic & Lasting Loyalty", description: "Attract more visitors to your website with targeted content and promotions. Build a loyal community that fosters repeat business and long-term customer relationships. Strengthen brand connections for sustained growth and engagement." },
              ],
              process: [
                { icon: <FaBullhorn />, title: "Initial Consultation", description: "Establish clear goals and objectives to guide the content marketing strategy." },
                ...
                { icon: <FaBullhorn />, title: "Content Planning and Creation", description: "Develop a strategic content calendar and produce engaging, high-quality content tailored to the audience." },
                { icon: <FaBullhorn />, title: "Campaign Launch and Management", description: "Implement the content marketing campaign and manage it for optimal reach and effectiveness." },
                { icon: <FaBullhorn />, title: "Engagement and Community Building", description: "Actively engage with the audience to foster relationships and build a vibrant community around the brand." },
                { icon: <FaBullhorn />, title: "Performance Monitoring and Reporting", description: "Track key performance indicators and provide insights to assess campaign success and inform future strategies." }
              ],
            });
            break;
